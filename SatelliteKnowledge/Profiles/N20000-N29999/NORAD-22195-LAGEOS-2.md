...
公开轨道目录将 LAGEOS 2 记录为 探索与科学中的科学任务。它的 NORAD 编号是 22195，国际编号是 1992-070B。这份文字是可编辑的本地基础档案；当你掌握更准确的任务、载荷或历史资料时，可以直接替换这一段。
...
- 1992 | 目录记录的发射年份或日期；完整日期可在核实后补充
- 2026-07-03 | 当前随包轨道元素的历元日期
