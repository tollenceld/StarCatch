...
公开轨道目录将 RADIO ROSTO (RS15) 记录为 通信与导航网络中的通信任务。它的 NORAD 编号是 23439，国际编号是 1994-085A。这份文字是可编辑的本地基础档案；当你掌握更准确的任务、载荷或历史资料时，可以直接替换这一段。
