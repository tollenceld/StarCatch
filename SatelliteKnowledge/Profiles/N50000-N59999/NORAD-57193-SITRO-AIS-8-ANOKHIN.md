...
当前目标是 2023-091AD / N57193：约 93.9 分钟绕地一周，沿97.5° 的近极轨道运行。 StarCatch 根据公开目录分组与名称，将它保守归入通信或导航网络节点；这是一项浏览分类，不是 GP/OMM 原始字段。公开条目不足以确认载荷和运营方，因此这里不作推测。

## 正文

### 可以确认的任务边界

StarCatch 根据公开目录分组与名称，将它保守归入通信或导航网络节点；这是一项浏览分类，不是 GP/OMM 原始字段。公开条目不足以确认载荷和运营方，因此这里不作推测。 当前目标是 2023-091AD / N57193：约 93.9 分钟绕地一周，沿97.5° 的近极轨道运行。

### 这条轨道的性格

它约 93.9 分钟绕地一周，运行在97.5° 的近极轨道上。平均轨道高度约 465 千米。离心率 0.00089，轨道非常接近圆形。这些数值描述轨道元素历元附近的结构，并不是永久不变的轨道铭牌。
