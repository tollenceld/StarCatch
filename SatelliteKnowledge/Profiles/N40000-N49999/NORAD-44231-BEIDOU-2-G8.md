...
公开轨道目录将 BEIDOU-2 G8 记录为 通信与导航网络中的导航授时。它的 NORAD 编号是 44231，国际编号是 2019-027A。这份文字是可编辑的本地基础档案；当你掌握更准确的任务、载荷或历史资料时，可以直接替换这一段。
...
- 2019-05-17 | 目录记录的发射年份或日期；完整日期可在核实后补充
