...
公开轨道目录将 FENGYUN 3D 记录为 地球与大气观测中的气象任务。它的 NORAD 编号是 43010，国际编号是 2017-072A。这份文字是可编辑的本地基础档案；当你掌握更准确的任务、载荷或历史资料时，可以直接替换这一段。
...
- 2017-11-14 | 目录记录的发射年份或日期；完整日期可在核实后补充
