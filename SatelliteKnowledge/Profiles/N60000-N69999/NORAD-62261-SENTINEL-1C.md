...
Copernicus 雷达观测任务，可穿透云层并在昼夜条件下记录陆地、海冰与海面变化。

## 正文

### 任务与身份

公开轨道目录将 SENTINEL-1C 记录为 地球与大气观测中的科学任务。它的 NORAD 编号是 62261，国际编号是 2024-235A。这份文字是可编辑的本地基础档案；当你掌握更准确的任务、载荷或历史资料时，可以直接替换这一段。
